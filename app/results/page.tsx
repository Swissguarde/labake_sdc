...
export default function FramesResultsPage() {
  ...
  const ResultCard = ({ children }: { children: React.ReactNode }) => (
    <div className="p-6 bg-white/5 backdrop-blur-lg border border-emerald-500/20 hover:border-emerald-500/40 hover:bg-emerald-500/5 transition-all rounded-xl">
      {children}
    </div>
  );

  const SectionTitle = ({ children }: { children: React.ReactNode }) => (
    <h3 className="text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400 mb-4">
      {children}
    </h3>
  );
  ...
  return (
    <motion.div
      ...
      className="p-12 pt-24 min-h-screen bg-gradient-to-tl from-gray-900 via-emerald-950 to-teal-900 text-white"
    >
      {/* Header Section */}
      <motion.div variants={itemVariants} className="flex items-center mb-12">
        <Link
          href="/"
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white/90 bg-white/5 hover:bg-emerald-500/10 backdrop-blur-lg rounded-lg transition-all border border-emerald-500/20 hover:border-emerald-500/40"
        >
          <svg
      ...
      <div className="mt-12 space-y-8 max-w-7xl mx-auto">
        <ScrollReveal>
          <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-400 mb-8">
                  ...
                  <ResultCard key={index}>
                    ...
                    <div className="space-y-3">
                      <div className="space-y-2">
                        ...
                        <div className="font-mono bg-gray-900/50 p-3 rounded-lg border border-emerald-500/20">
              ...
              <div className="p-6  backdrop-blur-sm rounded-xl border border-white/10">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="font-mono bg-gray-900/50 p-3 rounded-lg border border-emerald-500/20 space-y-2">
